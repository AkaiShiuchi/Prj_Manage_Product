...
@section('content')
    ...
    <div id="root"><!--<body id="Nhanh-template" class="index">-->
        ...
        <div class="page-user">
            <div class="container">
                <h1 class="title-user">Tài khoản</h1>
                <div class="clearfix"></div>
                <div class="row">
                    <div class="interlist col-sm-6 col-xs-12">
                        <div class="inter-title">Thông tin tài khoản</div>
                        <div class="clearfix"></div>
                        <div class="inter-info">
                            {{-- <a href="javascript:void(0)" class="text-green checkPoints">
                                Điểm Tích lũy của bạn: <strong> 0 </strong>
                            </a>
                            <a href="javascript:void(0)" class="text-green">
                                Cấp độ khách hàng: <strong> </strong>
                            </a> --}}
                            <a href="/profile/edit" class="text-green">
                                Thay đổi thông tin tài khoản </a>
                            <a href="/profile/changepassword" class="text-green">
                                Thay đổi mật khẩu </a>
                            <a href="/user/signout" class="text-green">
                                <i class="fa fa-sign-out"></i> Đăng xuất </a>
                        </div>
                    </div>

                    <div class="hidden interlist col-sm-6 col-xs-12">
                        <div class="inter-title">Quản lý đơn hàng</div>
                        <div class="clearfix"></div>
                        <div class="inter-info">
                            <a href="/order/index" class="text-green">
                                Quản lý đơn hàng </a>
                        </div>
                    </div>
                    <div class="interlist col-sm-6 col-xs-12">
                        ...
                        <div class="clearfix"></div>
                        {{-- <div class="inter-info">
                            <a href="/wishlist" class="text-green">
                                Sản phẩm yêu thích
                            </a>
                        </div> --}}
                        <div class="inter-info">
                            <a href="/history-order" class="text-green">
                                Lịch sử order
                            </a>
                        </div>
                    </div>
            ...
            <div id="site-search" class="site-nav-container" tabindex="-1">
                <div class="site-nav-container-last">
                    ...
                    <div class="search-box wpo-wrapper-search">
                        <meta itemprop="url" content="https://giadungnhanh.com/profile">
