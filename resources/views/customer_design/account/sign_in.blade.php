...
@section('style')
    <script src="{{ asset('js/customer/signin.js') }}"></script>
@endsection
        ...
        <main class="main-site main-childs">
            <div class="user-wrapper">
                <div class="user-nav anonymous-awe">
                    <a href="/user/signin" class="active" rel="nofollow">Đăng nhập</a>
                    <a href="/user/signup" rel="nofollow">Đăng ký</a>
                </div>
                <form accept-charset="UTF-8" id="formAcount" method="POST" action="/handle-signin">
                    @csrf
