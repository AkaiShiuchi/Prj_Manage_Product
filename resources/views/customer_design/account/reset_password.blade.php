        ...
        <div class="container">
            <div class="row">
                <div class="section-content block">
                    <div class="block">
                        <h1 class="section-title text-right col-md-12" style="margin: 20px 0 0 0;">
                            Lấy lại mật khẩu </h1>
                    </div>
                    <div class="clearfix"></div>

                    <form id="formAcount" method="POST" action="/handle-reset/{{ $user->id }}/{{ $remember_token }}"
                        class="formAcount validate col-md-6 col-sm-6 col-xs-12 clearfix">
                        @csrf
                        <div class="form-group clearfix">
                            <label for="newpassword" class="col-sm-12"> Mật khẩu mới (*): </label>
                            <div class="col-lg-12">
                        ...
                        <div class="form-group clearfix">
                            <label for="repassword" class="col-sm-12"> Nhập lại mật khẩu mới (*): </label>
                            <div class="col-lg-12">
                                <input type="password" id="confirm_password" name="confirm_password"
                                    placeholder="Nhập lại mật khẩu mới"
                                    class="validate[required],minSize[6],equals[newpassword] form-control">
                        ...
                        <div class="form-group clearfix text-center">
                            <button type="submit" name="submit" class="btn btn-green">Xác nhận</button>
                        </div>
                        <div class="clearfix"></div>
                    </form>
                </div>
            ...
            <div id="site-search" class="site-nav-container" tabindex="-1">
                <div class="site-nav-container-last">
                    ...
                    <div class="search-box wpo-wrapper-search">
                        <meta itemprop="url"
                            content="https://giadungnhanh.com/user/forgotpassword?email=kza10303@gmail.com&amp;resetKey=037480c4c34f3715eed032171ca2e56a">
