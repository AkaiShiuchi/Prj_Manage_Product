                                ...
                                <div class="heading-collection clearfix">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="heading-page" style="text-align: center;">
                                            <h1>Tìm kiếm</h1>
                                            <p class="subtxt">Có <span>{{ $results->count() }} sản phẩm</span> cho tìm kiếm
                                            </p>
                                        </div>
                                        <div class="append-search visible-xs"></div>
                                        <div class="filter-custom hidden-sm hidden-xs removeMobile">
                                            <p class="subtext-result"> Kết quả tìm kiếm cho
                                        ...
                                        <div class="product-resize col-md-3 col-sm-3  col-xs-6 pro-loop"
                                            ...
                                            <div class="product-block" data-anmation="1">
                                                <div class="product-img image-resize">
                                                    <a href="{{ asset('storage/uploads/' . $result->image) }}"
                                                        data-href="{{ asset('storage/uploads/' . $result->image) }}"
                                                        target="" class="p-img-box p-38929976  added"
                                                        data-fancybox="gallery">
                                                        <img class="img-loop lazyautosizes lazyloaded" data-sizes="auto"
                                                            src="{{ asset('storage/uploads/' . $result->image) }}"
                                                            data-id="38929976"
                                                            data-src="{{ asset('storage/uploads/' . $result->image) }}"
                                                            alt="{{ $result->name }}" sizes="280px">
                                                    </a>
                                                </div>
                                                    ...
                                                    <div class="product-detail clearfix">
                                                        ...
                                                        <div class="box-pro-detail">
                                                            ...
                                                            <div class="box-pro-prices">
                                                                <p class="pro-price highlight tp_product_price">
                                                                    <span
                                                                        class="pro-price-current">{{ number_format($result->price, 0, ',', '.') }}₫</span>
                                                                    <span class="pro-price-del">
                                                                        <span
                                                                            class="compare-price">{{ number_format($result->price, 0, ',', '.') }}₫</span>
                                                                    </span>
                                                ...
                                                <div class="actionLoop visible-lg">
                                                    <a class="quickView styleBtnBuy notClick"
                                                        data-id="{{ $result->id }}" data-toggle="modal"
                                                        data-target="#quickview-cart">
                                                        <i class="fa fa-shopping-cart"></i> Mua nhanh</a>
                                                    <a class="styleBtnBuy"
                                                        href="{{ route('product_detail', ['id' => $result->id]) }}">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <ul class="pagination justify-content-end">
                                                ...
                                                @else
                                                    <li class="page-item">
                                                        <a class="page-link"
                                                            href="{{ $results->previousPageUrl() }}">Previous</a>
                                                    </li>
                                                @endif

                                                @for ($page = 1; $page <= $results->lastPage(); $page++)
                                                    <li
                                                        class="paginate_button page-item {{ $results->currentPage() == $page ? 'active' : '' }}">
