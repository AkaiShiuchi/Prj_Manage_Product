                        ...
                        <div class="padding-lf-40 clearfix">
                            <div class=" ">
                                <ol class="breadcrumb breadcrumb-arrows clearfix" itemscope=""
                                    ...
                                    <meta itemprop="id" content="https://giadungnhanh.com/do-dung-nha-bep-pc565784.html">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope=""
                                        ...
                                        <span itemprop="name">{{ $categor->name }}</span>
                        ...
                        <div id="collection-body" class="wrap-collection-body clearfix">
                            <div class="wrap-collection-title clearfix">
                                <div class="heading-collection clearfix">
                                    <div class="col-md-8 col-sm-12 col-xs-12">
                                        <h1 class="title tp_title titleCategory" style="text-transform: uppercase;">
                                            {{ $categor->name }}</h1>
                                                ...
                                                <div class="contentFilter clearfix">
                                                    <div class="filter-color s-filter">
                                                        <ul class="check-box-list">
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1837661">
                                                                <input type="checkbox">
                                                                <label title="Loại thường" style="background-color: #">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1793437">
                                                                <input type="checkbox">
                                                                <label title="Nắp thìa" style="background-color: #">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1793434">
                                                                <input type="checkbox">
                                                                <label title="Lớn" style="background-color: #">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1793381">
                                                                <input type="checkbox">
                                                                <label title="Vuông" style="background-color: #">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1793368">
                                                                <input type="checkbox">
                                                                <label title="Mẫu thường" style="background-color: #">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1793362">
                                                                <input type="checkbox">
                                                                <label title="Dao thái trung" style="background-color: #">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1793361">
                                                                <input type="checkbox">
                                                                <label title="Dao thái nhỏ" style="background-color: #">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1793360">
                                                                <input type="checkbox">
                                                                <label title="Kéo bấm" style="background-color: #">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1547073">
                                                                <input type="checkbox">
                                                            ...
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1219619">
                                                                <input type="checkbox">
                                                                <label title="Đen" style="background-color: ##000000">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1154547">
                                                                <input type="checkbox">
                                                                <label title="Xanh dương"
                                                                    style="background-color: #6698FF">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?i1=1154546">
                                                                <input type="checkbox">
                                                                <label title="Hồng" style="background-color: #FAAFBE">
                                                                    <span class="button tp_button"></span>
                                                                </label>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="filter-price s-filter tp_product_category_filter_price">
                                                        <ul class="check-box-list clearfix">
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?price=0: 200000">
                                                                <input type="checkbox">
                                                                <label><span class="button tp_button"></span>Dưới 200,000
                                                                </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?price= 200000: 500000">
                                                                <input type="checkbox">
                                                                <label><span class="button tp_button"></span>Từ 200,000 -
                                                                    500,000 </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?price= 500000: 1000000">
                                                                <input type="checkbox">
                                                                <label><span class="button tp_button"></span>Từ 500,000 -
                                                                    1,000,000 </label>
                                                            </li>
                                                            <li class="filter-item"
                                                                data-filter="/do-dung-nha-bep-pc565784.html?price= 1000000">
                                                                <input type="checkbox">
                                            ...
                                            <div class="borderFilterMobile option browse-tags">
                                                ...
                                                <span class="custom-dropdown custom-dropdown--grey">
                                                    ...
                                                    <select class="sort-by custom-dropdown__select"
                                                        onchange="location = this.value" fdprocessedid="lyuq8c">
                                                        <!--                                            <option value="manual" data-filter="manual">Tùy chọn</option>-->
                                                        <option value="/do-dung-nha-bep-pc565784.html?">Mới nhất</option>
                                                        <option value="/do-dung-nha-bep-pc565784.html?show=priceDesc">Giá
                                                            giảm dần</option>
                                                        <option value="/do-dung-nha-bep-pc565784.html?show=priceAsc">Giá
                                                            tăng dần</option>
                                                        <option value="/do-dung-nha-bep-pc565784.html?show=discount">Sale
                                                        </option>
                                                    </select>
                                                </span>
                                            </div>
                            ...
                            <div class="clearfix filter-here">
                                <div class=" content-product-list product-list filter clearfix fixBox" itemscope=""
                                    ...
                                    <meta itemprop="url" content="/do-dung-nha-bep-pc565784.html">
                                    <meta itemprop="name" content="ĐỒ DÙNG NHÀ BẾP">
                                            ...
                                            <div class="product-block" data-anmation="1">
                                                <div class="product-img image-resize">
                                                    <a href="{{ asset('storage/uploads/' . $product->image) }}"
                                                        ...
                                                        target="" class="p-img-box p-38929976  added"
                                                            ...
                                                            <div class="box-pro-prices">
                                                                <p class="pro-price highlight tp_product_price">
                                                                    ...
                                                                    <span class="pro-price-del">
                                                                        <span class="compare-price">15,100₫</span>
                                                                    </span>
            ...
            <div id="site-search" class="site-nav-container" tabindex="-1">
                <div class="site-nav-container-last">
                    ...
                    <div class="search-box wpo-wrapper-search">
                        <meta itemprop="url" content="https://giadungnhanh.com/do-dung-nha-bep-pc565784.html">
