                                            ...
                                            <div class="borderFilterMobile option browse-tags">
                                                ...
                                                <span class="custom-dropdown custom-dropdown--grey">
                                                    ...
                                                    <select class="sort-by custom-dropdown__select"
                                                        ...
                                                        <option
                                                            value="{{ route('search_category', ['show' => 'default', 'id' => $categor->id]) }}"
                                                            {{ request('show') == 'default' ? 'selected' : '' }}>Mặc định
                                                        </option>
                                                        <option
                                                            value="{{ route('search_category', ['show' => 'priceDesc', 'id' => $categor->id]) }}"
                                                            {{ request('show') == 'priceDesc' ? 'selected' : '' }}>Giá giảm
                                                            dần</option>
                                                        <option
                                                            value="{{ route('search_category', ['show' => 'priceAsc', 'id' => $categor->id]) }}"
                                                            {{ request('show') == 'priceAsc' ? 'selected' : '' }}>Giá tăng
                                                            dần</option>
                                                        {{-- <option
                                                            value="{{ route('search_category', ['show' => 'discount']) }}"
                                                    ...
                                                    <div class="product-detail clearfix">
                                                        ...
                                                        <div class="box-pro-detail">
                                                            ...
                                                            <div class="box-pro-prices">
                                                                <p class="pro-price highlight tp_product_price">
                                                                    <span
                                                                        class="pro-price-current">{{ number_format($product->price, 0, ',', '.') }}₫</span>
                                                                    <span class="pro-price-del">
                                                                        <span
                                                                            class="compare-price">{{ number_format($product->price, 0, ',', '.') }}₫</span>
                                                                    </span>
