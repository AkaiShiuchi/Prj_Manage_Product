<table class="datatables-order table border-top dataTable no-footer dtr-column" id="data_table"
    ...
    <thead>
        <tr>
            ...
            <th class="" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                style="width: 123px;" aria-label="date: activate to sort column descending" aria-sort="ascending">order
            </th>
            <th class="" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                ...
                <td>
                    <div class="d-flex justify-content-sm-center align-items-sm-center">
                        ...
                        <div class="dropdown-menu dropdown-menu-end m-0" style="">
                            <a href="{{ route('detail_purchase', ['id' => $pur->id]) }}" class="dropdown-item">View</a>
