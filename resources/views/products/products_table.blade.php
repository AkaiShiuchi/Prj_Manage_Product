<table class="datatables-products table border-top dataTable no-footer dtr-column collapsed" id="products_table"
    aria-describedby="DataTables_Table_0_info" style="width: 1211px;">
    <thead>
        <tr>
            <th class="control sorting_disabled" rowspan="1" colspan="1" style="width: 3px;" aria-label="">stt</th>
                        ...
                        <div class="d-flex justify-content-start align-items-center product-name">
                            ...
                            <div class="d-flex flex-column">
                                <h6 class="text-body text-nowrap mb-0">
                                    {{ $item->name }}</h6>
                                <small class="text-muted text-truncate d-none d-sm-block">{{ $item->describe }}</small>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="dtr-hidden">
                        <div class="d-inline-block text-nowrap">
                            ...
                            <div class="dropdown-menu dropdown-menu-end m-0">
                                <a href="{{ route('view_detail', ['id' => $item->id]) }}" class="dropdown-item">View</a>
